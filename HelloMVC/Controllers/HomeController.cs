...
namespace HelloMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        //creating an interface for our controller
        public HomeController()
        {
            customers = cache["customers"] as List<Customer>; //telling the cache to store the list of customers.
            if (customers == null)
            {
        ...
        public ActionResult Index()//default page
        {
            return View();
        }
